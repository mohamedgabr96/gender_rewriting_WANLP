...
import sys
sys.path.append("../")
from utils_speaker_listener import create_dataloaders, yaml_loader
import wandb
...
def main(config):
    ...
    ## Model Loading
    wandb.init(project="my-gender-rewrite-project-speaker_listener",
    ...
    label_names = ["NONE", "SPEAKER", "LISTENER", "PAD"]
