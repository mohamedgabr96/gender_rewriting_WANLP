...
direction = "FF"
model_name = "/mnt/default/zcodetasks/code/mogabr-codes/proj_git_2/gender_rewriting_WANLP/save_folder_FF_arat5msa_seq2seq_augmented/dev_40000/"
...
with open(os.path.join(path_to_output, "output22_" + direction + ".txt"), encoding="utf-8", mode="w") as file_opened:
